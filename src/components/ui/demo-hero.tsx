      ...
      <div className="w-full max-w-6xl space-y-0 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-5xl mx-auto animate-in fade-in duration-700 delay-300">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="backdrop-blur-sm bg-card/50 border border-border rounded-xl p-4 md:p-6 h-40 md:h-48 flex flex-col justify-start items-start space-y-2 md:space-y-3 hover:bg-card/70 transition-all duration-300 hover:scale-105"
              style={{

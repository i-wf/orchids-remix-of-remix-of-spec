      ...
      <div className="relative min-h-screen flex items-center justify-center py-16 px-4">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center w-full max-w-4xl mx-auto space-y-6 animate-in fade-in duration-1000">
          <div className="backdrop-blur-sm bg-black/20 border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <p className="text-muted-foreground text-lg font-light text-center w-full max-w-2xl mx-auto animate-in fade-in duration-700 delay-300 mt-4">
              منصة تعليمية متكاملة مدعومة بالذكاء الاصطناعي - من الصف الرابع الابتدائي إلى الثالث الثانوي
            </p>
            
            <div className="flex flex-wrap items-center justify-center gap-3 w-full animate-in slide-in-from-bottom-2 duration-700 delay-400 mt-6">
              <Button
                size="lg"
            ...
            <ul className="flex flex-wrap justify-center gap-6 text-xs font-light tracking-tight text-muted-foreground w-full animate-in fade-in duration-700 delay-500 mt-6">
